...
logit op2021_original c.ruc##(i.region) ventas_k i.sector sexo_gerente ///
...
gen ventas_k_micro = (ventas_soles_2021 - r(mean)) / r(sd)

logit op2021_original c.ruc##(i.region) ventas_k_micro i.sector sexo_gerente ///
      productividad_k digital_score i.tipo_local, vce(cluster ciiu_4dig)
...
// Re-estandarizar ventas en submuestra
quietly summarize ventas_soles_2021
gen ventas_k_pequena = (ventas_soles_2021 - r(mean)) / r(sd)

logit op2021_original c.ruc##(i.region) ventas_k_pequena i.sector sexo_gerente ///
      productividad_k digital_score i.tipo_local, vce(cluster ciiu_4dig)
